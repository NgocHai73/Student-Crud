...
if(isset($_POST['update_product'])){
   ...
   if(empty($product_name) || empty($product_price) || empty($product_disceiption) || empty($product_image)){
      ...
      $update_data = "UPDATE products SET name='$product_name', price='$product_price', description='$product_disceiption', image='$product_image'  WHERE id = '$id'";
...
<div class="admin-product-form-container centered">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <textarea name="product_disceiption" class="box" placeholder="enter the product disceiption"><?php echo $row['disceipyion']; ?></textarea>
